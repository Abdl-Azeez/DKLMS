  ...
  <navigation  class='fixed-top navbar navbar-expand-lg navbar-dark nav-style'>
    ...
    <button class='navbar-toggler' type='button' data-toggle='collapse' data-target='#navbarNav' aria-controls='navbarNav' aria-expanded='false' aria-label='Toggle navigation'>
      ...
      <ul class='ul-class nav navbar-nav borderEffect'>
        <li class='nav-item'><a href='\DK\Admin\Records.php' style='padding-left:8px;' class="ml-2">Requests</a></li>
        <li class='nav-item'><a href='\DK\Admin\AllRecords.php'>Records</a></li>
        <li class='nav-item'><a href='\DK\Admin\Users.php'>Users</a></li>
        <li class='activated'><a href='\DK\Admin\Profile.php' style='color: #121307;'>Profile</a></li>
      ...
      <div class='profileSection col-md-12'>
        ...
        <input type=\"hidden\" value=\"updateimage\" name=\"updateimage\">
          <div class='profilePicture'>
            <a href=\"";if ($myrow[22]==""){echo "\DK\images\userPlaceholder.png";}else{echo"\DK\Admin\ProfilePictures\\$myrow[22]";};echo"\" target=\"_blank\">
              <img src='";if ($myrow[22]==""){echo "\DK\images\userPlaceholder.png";}else{echo"\DK\Admin\ProfilePictures\\$myrow[22]";};echo"'/>
            </a>
...
function rowdel(){
  if(confirm("Are you sure you want to remove your profile picture?")){
    ...
    ({
        type:'post',
        url:'/DK/Admin/Picturedel.php?empid=<?php echo "$myrow[0]";?>',
        data:{
...
function Profile()
{
   ...
   var r = confirm("You are about to update your profile\n Press OK to proceed \nCANCEL to terminate the process");
    if (r == true) {
      ...
      ({
          type:'post',
          url:'/DK/Admin/UpdateProfile.php',
          data:formdata,
          contentType: false,
          processData: false,
          success: function (response) {
...
function image()
{
   ...
   var r = confirm("You are about to update your profile picture\n Press OK to proceed \nCANCEL to terminate the process");
    if (r == true) {
      ...
      ({
          type:'post',
          url:'/DK/Admin/UpdatePicture.php',
          data:formdata,
          contentType: false,
          processData: false,
          success: function (response) {
