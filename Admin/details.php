    ...
    <div class='content'>
      ...
      <div class="profileSection">
        ...
        <div class="profilePicture">
            <img src='<?php if ($myrow[19]==""){echo "\DK\images\userPlaceholder.png";}else{echo"\DK\Superior\ProfilePictures\\$myrow[19]";};?>'/>
        ...
        <form class="" name="userUpdate" method="post" action="ProcessDetails.php?leaveid=<?php echo $myrow[0];?>" onsubmit="return UpdateDetail();">
          ...
          <div class="form-group" id="statuss">
            ...
            <?php if($myrow[7]==0)
              ...
              if($myrow[7]==2){
              echo "<section style=\"padding: 5px 239px;\"><span style='color: blue'>Waiting For HR Approval</span>";
              }
              if($myrow[7]==4){
          ...
          <div class="formbutton">
              <?php if (($myrow[7]==0) && ($myrow[8]=='Superior')){?>
...
<script type="text/javascript">
  function UpdateDetail()
  {
     ...
     document.getElementById('wait').style.display="";
      ...
      ({
          type:'post',
          url:'/DK/Admin/ProcessDetails.php?leaveid=<?php echo $myrow[0];?>',
          data:{
           UpdateDetail:"UpdateDetail",
           status:status
          },
          success: function (response) {
            if ((response=="success") || (response=="Action recorded but fail to send to Superior mail"))
              {
                alert("Action Taken");
