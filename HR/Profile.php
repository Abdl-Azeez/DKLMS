...
<main>
  <navigation  class='fixed-top navbar navbar-expand-lg navbar-dark nav-style'>
    ...
    <button class='navbar-toggler' type='button' data-toggle='collapse' data-target='#navbarNav' aria-controls='navbarNav' aria-expanded='false' aria-label='Toggle navigation'>
      ...
      <ul class='ul-class nav navbar-nav borderEffect'>
        ...
        <li class='activated'><a href='\DK\HR\Profile.php' style='color: #121307;'>Profile</a></li>
  ...
  <div class='component'>
    ...
    <?php
      ...
      $user=$_SESSION['username'];
      $sql= "SELECT * FROM users WHERE username='$user' AND roles='HR'";
      $result= mysqli_query ($connection, $sql) or die ("Could not execute query");
      ...
      <div class='profileSection col-md-12'>
        ...
        <input type=\"hidden\" value=\"updateimage\" name=\"updateimage\">
          <div class='profilePicture'>
            <a href=\"";if ($myrow[22]==""){echo "\DK\images\userPlaceholder.png";}else{echo"\DK\HR\ProfilePictures\\$myrow[22]";};echo"\" target=\"_blank\">
              <img src='";if ($myrow[22]==""){echo "\DK\images\userPlaceholder.png";}else{echo"\DK\HR\ProfilePictures\\$myrow[22]";};echo"'/>
            </a>
...
$connection = mysqli_connect("localhost", "root", "", "FYP") or die ("Couldn't connect to server");
$user=$_SESSION['username'];
$sql= "SELECT * FROM users WHERE roles='HR' AND username='$user'";
$result= mysqli_query ($connection, $sql) or die ("Could not execute query");
$myrow= mysqli_fetch_row ($result);
?>
...
function rowdel(){
  if(confirm("Are you sure you want to remove your profile picture?")){
    ...
    ({
        type:'post',
        url:'/DK/HR/Picturedel.php?empid=<?php echo "$myrow[0]";?>',
        data:{
