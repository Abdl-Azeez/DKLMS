...
if(isset($_POST['submit']))
{
  ...
  $myrow= mysqli_fetch_row ($result);
      ...
      $str = "0123456789qwertzuioplkjhgfdsayxcvbnm";
			$str = str_shuffle($str);
			$str = substr($str, 0, 6);
			$url = "localhost/DK/resetPassword.php?token=$str&email=$email";
  ...
  <body>
    <div class="box" style="height:50%;">
        ...
        <form method="post"  action="<?php $SELF_PHP; ?>">
          <div class="inputBox">
                <label><i class="fa fa-envelope-o" aria-hidden="true"></i>Email <font color='orange'>  *</font></label>
                <input type="email" name="eamil"  placeholder="Email used to register" required >
