  ...
  <link rel="stylesheet" href="\DK\css\ChangePassword.css">
  <?php
    include'display.php';
  ?>
</head>
    ...
    <navigation  class='fixed-top navbar navbar-expand-lg navbar-dark nav-style'>
      <div class='logo' style="width: 29%;">
        ...
        <ul class='ul-class nav navbar-nav borderEffect'>
         <li class='nav-item'><a href='\DK\Staff\RECORDS.php' style='padding-left:8px;' class="ml-2">Records</a></li>
         <li class='nav-item'><a href='\DK\Staff\Request.php'>Apply</a></li>
         <li class='nav-item'><a href='\DK\Staff\Profile.php'>View Profile</a></li>
         <li class='activated'><a href='' style='color: #1463f7fc;'>Change Password</a></li>
              ...
              if (response=="success")
                {
                  ...
                  setTimeout(function(){
                    window.location.href= "/DK/logout.php";
                  }, 1000)
                }
              else{
                alert(response);
