  ...
  $(window).on('load',function () {
    ...
    if (viewportWidth < 1060) {
          $("#Image").removeClass("col-md-6").addClass("col-md-12");
          $("#Profile").removeClass("col-md-6").addClass("col-md-12");
    }
    else if (viewportWidth >= 1060) {
          $("#Image").removeClass("col-md-12").addClass("col-md-6");
          $("#Profile").removeClass("col-md-12").addClass("col-md-6");
    }
  });
    ...
    <navigation  class='fixed-top navbar navbar-expand-lg navbar-dark nav-style'>
      <div class='logo' style="width: 29%;">
        ...
        <ul class='ul-class nav navbar-nav borderEffect'>
         ...
         <li class='activated'><a href='' style='color: #1463f7fc;'>View Profile</a></li>
        ...
        <div class='profileSection col-md-12'>
          ...
          <input type=\"hidden\" value=\"updateimage\" name=\"updateimage\">
            <div class='profilePicture'>
              <a href=\"";if ($myrow[22]==""){echo "\DK\images\userPlaceholder.png";}else{echo"\DK\Staff\ProfilePictures\\$myrow[22]";};echo"\" target=\"_blank\">
                <img src='";if ($myrow[22]==""){echo "\DK\images\userPlaceholder.png";}else{echo"\DK\Staff\ProfilePictures\\$myrow[22]";};echo"'/>
              </a>
...
<script type="text/javascript">
  function rowdel(){
    if(confirm("Are you sure you want to remove your profile picture?")){
      ...
      ({
          type:'post',
          url:'/DK/Staff/Picturedel.php?empid=<?php echo "$myrow[0]";?>',
          data:{
  ...
  function Profile()
  {
     ...
     var r = confirm("You are about to update your profile\n Press OK to proceed \nCANCEL to terminate the process");
      if (r == true) {
        ...
        ({
            type:'post',
            url:'/DK/Staff/UpdateProfile.php',
            data:formdata,
            contentType: false,
            processData: false,
            success: function (response) {
  ...
  function image()
  {
     ...
     var r = confirm("You are about to update your profile picture\n Press OK to proceed \nCANCEL to terminate the process");
      if (r == true) {
        ...
        ({
            type:'post',
            url:'/DK/Staff/UpdatePicture.php',
            data:formdata,
            contentType: false,
            processData: false,
            success: function (response) {
