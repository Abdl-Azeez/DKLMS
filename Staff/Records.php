...
?>
  ...
  #tdstatus{font-weight: 600; width: 130px;}
  #leavename{width: 130px;}
  ...
  @media
    ...
    and (max-device-width: 1024px)  {
      ...
      td:nth-of-type(3):before { content: "Total Leaves"; }
      td:nth-of-type(4):before { content: "Leave Taken"; }
      ...
      td:nth-of-type(9):before { content: "Superior Remark"; }
      td:nth-of-type(10):before { content: "Details"; }
    }
  </style>
</head>
<body>
  ...
  <main>
    <navigation  class="fixed-top navbar navbar-expand-lg navbar-dark nav-style">
      <div class='logo' style="width: 29%;">
        ...
        <ul class="ul-class nav navbar-nav borderEffect">
         <li class="activated"><a href="" style="color: #1463f7fc;" class="ml-2">Records</a></li>
         <li class="nav-item"><a href="\DK\Staff\Request.php">Apply</a></li>
         <li class="nav-item"><a href="\DK\Staff\Profile.php">View Profile</a></li>
         <li class="nav-item"><a href="\DK\Staff\ChangePassword.php">Change Password</a></li>
         <li class="nav-item" style="display:none;"><a href="\DK\Login.php">Logout</a></li>
        </ul>
			</div>
      <div class="userProfileImage">
        <img src='<?php if ($myrow[22]==""){echo "\DK\images\userPlaceholder.png";}else{echo"\DK\Staff\ProfilePictures\\$myrow[22]";};?>'/>
        <section style="display: inline-flex;justify-content: space-around;">
          <a href="javascript:void(0)" data-activates="dropdown1" class="dropdown-button">
            ...
            $sql = "SELECT COUNT(*) AS 'count' FROM request INNER JOIN users ON users.StaffID = request.StaffID WHERE users.username='$user' AND request.checked=0 AND request.status>0";
          ...
          <ul id="dropdown1" class="dropdown-content" style="width: 46px; position: absolute;top: 0px;left: 1034.75px;opacity: 1; display: none;">
            <li class="notificatoins-dropdown-container">
              <ul>
                ...
                <?php
                $user=$_SESSION['username'];
                $sql2 = "SELECT request.Id AS lid, request.StaffName, request.StaffID, request.leaveType, request.DateFrom, request.DateTo, request.Attachment, request.PostingDate, users.Department, request.status FROM request INNER JOIN users ON users.StaffID = request.StaffID
                WHERE users.username='$user' AND  request.checked=0 AND request.status>0 ORDER BY request.PostingDate desc";
                  ...
                  <a href="details.php?leaveid=<?php echo $myrow["lid"];?>" name="checked" id="checked">
                    <div class="notification">
                      ...
                      <div class="notification-text"><p><b><?php if ($myrow["leaveType"]==1)
                            ...
                            };?><br/></b> applied on <?php echo $myrow["PostingDate"];?></p><span>as been attended to by <?php if (($myrow["status"]==2)||($myrow["status"]==3)){echo "Superior";} else{echo "HR";}?></span>
                          </div>
                        </div>
                          <?php }}?>
    ...
    <div class="component">
      ...
      <div class="search-box">
        <input type="text" class="search-txt" id="searchInput" onkeyup="myFunction()" placeholder="Search for Leave type.." title="Type in Leave type">
        ...
        <?php
          ...
          echo"
            ...
            if ($myrow[0]>0){
              do{
                echo"
                  ...
                  <tr>
                    ...
                    echo"</td>
                    <td id=\"datefromto\">$myrow[3]</td>
                    <td id=\"datefromto\">$myrow[4]</td>
                    <td id=\"NoDays\">$myrow[20]</td>
                    <td id=\"tdstatus\">";
                        if($myrow[5]==0)  {
                        ...
                        if($myrow[5]==2){
                        echo "<span style='color: blue'>Waiting for HR Approval</span>";
                        }
                        if($myrow[5]==3){
                        echo "<span style='color: red'>Not Recommended by Superior</span>";
                        }
                        if($myrow[5]==4){
                        echo "<span style='color: red'>Not Approved by HR</span>";
                        }
                        echo"
                    </td>
                    <td>"; if($myrow[5]==0)  {
              ...
              echo"<span class='NotFound' style=\"display:none;\" id=\"noresults\">No Leave type has \"<span id=\"qt\"></span>\"</span></table>";
          }
          else {
