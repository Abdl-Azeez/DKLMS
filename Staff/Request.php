    ...
    <navigation  class='fixed-top navbar navbar-expand-lg navbar-dark nav-style'>
      <div class='logo' style="width: 29%;">
        ...
        <ul class='ul-class nav navbar-nav borderEffect'>
         <li class='nav-item'><a href='\DK\Staff\Records.php' class="ml-3" style="padding-left:8px;">Records</a></li>
         <li class='activated'><a href='\DK\Staff\Request.php' style='color: #1463f7fc;'>Apply</a></li>
  ...
  <script type="text/javascript">
      ...
      var process_form = function()
      {
        ...
        document.getElementById('wait').style.display="";
         $.ajax({
           type: 'post',
           url: '/DK/Staff/ProcessRequest.php',
           data: formdata,
           contentType: false,
           processData: false,
           success: function (response) {
             if ((response=="success") || (response=="Request sent but fail to send to superior mail"))
               {
