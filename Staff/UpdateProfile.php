<?php
  ...
  if (isset ($_POST['UpdateProfile'])){
    ...
    $user=$_SESSION['username'];
  	...
  	$sql="UPDATE users SET StaffID = '$StaffID' , Username= '$Username' , Email ='$Email', StaffName= '$Full_Name', MobileNum= '$Mobile', Gender= '$Gender' WHERE username='$user' AND roles='staff'";
