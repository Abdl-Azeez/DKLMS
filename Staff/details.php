...
include "session.php";
    $lid=intval($_GET['leaveid']);
		$checkNum=1;
    $sql2 = "SELECT users.StaffName, request.status, users.Profileimg FROM request INNER JOIN users ON users.StaffID = request.StaffID WHERE users.username='$user' AND users.roles='Staff'";
    ...
    <navigation  class='fixed-top navbar navbar-expand-lg navbar-dark nav-style'>
      ...
      <button class='navbar-toggler' type='button' data-toggle='collapse' data-target='#navbarNav' aria-controls='navbarNav' aria-expanded='false' aria-label='Toggle navigation'>
        ...
        <ul class='ul-class nav navbar-nav borderEffect'>
          <li class="nav-item"><a href="\DK\Staff\Records.php" class="ml-2">Records</a></li>
      ...
      <div class="profileSection">
        ...
        <form class="" name="userUpdate" method="post" action="ProcessDetails.php?leaveid=<?php echo $myrow[0];?>" onsubmit="return UpdateDetail();">
          ...
          <div class=\"form-group\">
            ...
            <a href=\"/DK/Staff/uploadeddata/$myrow[3]\" target=\"_blank\"><img id=\"viewicon\" src=\"/DK/images/Attach.png\"></a><input type=\"text\" readonly>
          </div>
          ";}?>
          <div id="ActDate"><?php
          ...
          <div class="form-group" id="statuss">
            ...
            <?php   if($myrow[7]==0)
             {
              echo "<section style=\"padding: 5px 280px;\"><span style='background: #0c4c5d; color: Yellow'>Pending</span>";
               }
              if($myrow[7]==1){
              echo "<section style=\"padding: 5px 280px;\"><span style='color: green'>Approved</span>";
              }
              if($myrow[7]==2){
              echo "<section style=\"padding: 5px 214px;\"><span style='color: blue'>Waiting for HR Approval</span>";
              }
              if($myrow[7]==3){
              echo "<section style=\"padding: 5px 264px;\"><span style='color: red'>Not Approved</span>";
              }
              if($myrow[7]==4){
              echo "<section style=\"padding: 5px 264px;\"><span style='color: red'>Not Approved by HR</span>";
              }
              ?>  </section>
          </div>
...
<script type="text/javascript">
  function UpdateDetail()
  {
     ...
     var remark=$("#remark").val();
      ...
      ({
          type:'post',
          url:'/DK/Staff/ProcessDetails.php?leaveid=<?php echo $myrow[0];?>',
          data:{
