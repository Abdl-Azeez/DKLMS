    ...
    <navigation  class="fixed-top navbar navbar-expand-lg navbar-dark nav-style">
      <div class='logo' style="width: 24%;">
        ...
        <ul class='ul-class nav navbar-nav borderEffect'>
         ...
         <li class='activated'><a href='\DK\Superior\Record.php' style='color: #1463f7fc;'>My Records</a></li>
    ...
    <div class="component">
      ...
      <div style="display: flex;justify-content: space-around;width: 100%;margin-top: 50px;">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body" method="post">
                  <div class="modal-form-content">
                    <input type="hidden"  name="empname" id="empname" value="<?php echo $rowselected[5]?>">
        ...
        <?php
          ...
          users.StaffID = request.StaffID WHERE users.username='$user' AND users.roles='Superior' ORDER BY request.PostingDate desc";
          $result= mysqli_query ($connection, $sql) or die ("Could not execute query");
              ...
              do{
                echo"
                  ...
                  <tr>
                    ...
                    <td>"; if($myrow[5]==0)  {
                              echo "<span>Waiting for C.E.O Action</span>";
                           }
