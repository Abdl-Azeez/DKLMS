...
@media
  ...
  and (max-device-width: 1024px)  {
    ...
    td:nth-of-type(3):before { content: "Leave Type"; }
    td:nth-of-type(4):before { content: "From"; }
    td:nth-of-type(5):before { content: "To"; }
    td:nth-of-type(6):before { content: "No. Of Days"; }
    td:nth-of-type(7):before { content: "Posting Date"; }
  ...
  <main>
    <navigation  class='fixed-top navbar navbar-expand-lg navbar-dark nav-style'>
      ...
      <button class='navbar-toggler' type='button' data-toggle='collapse' data-target='#navbarNav' aria-controls='navbarNav' aria-expanded='false' aria-label='Toggle navigation'>
        ...
        <ul class='ul-class nav navbar-nav borderEffect'>
         <li class='nav-item'><a href='\DK\Superior\Records.php' class="ml-2" style="padding-left:8px;">Staff&nbspRequests</a></li>
         <li class='activated'><a href='\DK\Superior\StaffRecords.php' style='color: #121307;'>Staff Records</a></li>
    ...
    <div class='component'>
      ...
      <div class="search-box">
        <input type="text" class="search-txt" id="searchInput" onkeyup="myFunction()" placeholder="Search Staff name.." title="Type in Staff name">
      ...
      <div style="display: flex;justify-content: space-around;width: 100%;margin-top: 50px;">
        ...
        <?php
          ...
          $user=$_SESSION['username'];
          $status=0;
          $sql= "SELECT request.Id, request.StaffName, request.NoDays, request.leaveType, request.DateFrom, request.DateTo, request.Attachment, request.PostingDate, request.Position, request.status,
           users.ELtaken, users.ELbalance, users.CLtaken, users.CLbalance, users.Annualtaken, users.Annualbalance, users.OLtaken, users.OLbalance FROM request INNER JOIN users ON users.Department = request.Departments WHERE users.StaffID = request.StaffID AND request.status>$status AND users.roles='Staff'
           ORDER BY  request.ActionDate desc";
          $result= mysqli_query ($connection, $sql) or die ("Could not execute query");
          ...
          if ($myrow[0]>0){
            do{
              echo"
                      <tbody>
                        <tr>
                          ...
                          <td>$myrow[5]</td>
                          <td>$myrow[2]</td>
                          <td id=\"tdpostingdate\">$myrow[7]</td>
                          <td id=\"tdstatus\">";
                                if($myrow[9]==0)  {
              ...
              echo" <span class='NotFound' style=\"display:none; top:75%!important;\" id=\"noresults\">No Names of Staff has \"<span id=\"qt\"></span>\"</span></table>";
            }
          else {
