    ...
    <navigation  class='fixed-top navbar navbar-expand-lg navbar-dark nav-style'>
      ...
      <button class='navbar-toggler' type='button' data-toggle='collapse' data-target='#navbarNav' aria-controls='navbarNav' aria-expanded='false' aria-label='Toggle navigation'>
        ...
        <ul class='ul-class nav navbar-nav borderEffect'>
         <li class='nav-item'><a href='\DK\Superior\Records.php' class="ml-2" style="padding-left:8px;">Staff Requests</a></li>
         <li class='nav-item'><a href='\DK\Superior\StaffRecords.php'>Records</a></li>
         <li class='nav-item'><a href='\DK\Superior\Request.php'>Apply</a></li>
         <li class='nav-item'><a href='\DK\Superior\Profile.php'>View Profile</a></li>
    ...
    <div class='content'>
      ...
      <div class="profileSection">
        <?php
          ...
          users.OLbalance, users.Profileimg, request.leaveType, users.TOS, users.roles
          FROM request LEFT JOIN USERS ON USERS.StaffID = REQUEST.StaffID WHERE request.Id=$lid";
          $result= mysqli_query ($connection, $sql) or die ("Could not execute query");
          $myrow= mysqli_fetch_row ($result);
        ?>
        <div class="profilePicture">
            <img src='<?php if ($myrow[17]==""){echo "\DK\images\userPlaceholder.png";}else{echo"\DK\Staff\ProfilePictures\\$myrow[17]";};?>'/>
        ...
        <form class="" name="userUpdate" method="post" action="ProcessDetails.php?leaveid=<?php echo $myrow[0];?>" onsubmit="return UpdateDetail();">
          ...
          <div class=\"form-group\">
            ...
            <a href=\"/DK/Staff/uploadeddata/$myrow[8]\" target=\"_blank\"><img id=\"viewicon\" src=\"/DK/images/Attach.png\"></a><input type=\"text\" readonly>
          </div>
          ";}?>
          <div class="form-group">
            <label>Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label>
          ...
          <div class="formbutton">
              <?php if (($myrow[7]==0) && ($myrow[20]=='Staff')){?>
...
<script type="text/javascript">
  function UpdateDetail()
  {
     ...
     document.getElementById('wait').style.display="";
      ...
      ({
          type:'post',
          url:'/DK/Superior/ProcessDetails.php?leaveid=<?php echo $myrow[0];?>',
          data:{
