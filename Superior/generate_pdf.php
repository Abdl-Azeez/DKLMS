...
if (isset($_POST['Formsubmit']))
{
  ...
  if($row==''){
    ...
    if ($leaveType==1){$balance=$Annualbalance;}
    else if ($leaveType==2){$balance=$Annualbalance;}
    else if ($leaveType==3){$balance=$CLbalance;}
    else if ($leaveType==4){$balance=$OLbalance;}

    if ($leaveType==1){$taken=$Annualtaken;}
    else if ($leaveType==2){$taken=$ELtaken;}
    else if ($leaveType==3){$taken=$CLtaken;}
    ...
    $y_axis_initial = 42;
    if (($empleave!=5)&&($empname!=5)){$x_axis=35;}
    else if (($empleave==5) && ($empname!=5)){$x_axis=25;}
    else if (($empleave!=5) && ($empname==5)){$x_axis=25;}
    ...
    if (($empleave!=5)&&($empname!=5)){$pdf->Cell(30,6,'Status',1,0,'L',1);}
    else if (($empleave==5) && ($empname!=5)){$pdf->Cell(30,6,'Status',1,0,'L',1);}
    else if (($empleave!=5) && ($empname==5)){$pdf->Cell(30,6,'Status',1,0,'L',1);}
