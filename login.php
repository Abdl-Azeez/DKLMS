    ...
    <div id="wrapper">
      ...
      <div class="box">
          ...
          <form method="post" action="do_login.php" onsubmit="return do_login();">
            <div class="inputBox">
                  <label><i class="fa fa-user" aria-hidden="true"></i>Username <font color='red'>  *</font></label>
                  <input type="text" id="username" name="username"  placeholder="Enter User Name" required >

              </div>
            <div class="inputBox">
                  <label><i class="fa fa-unlock-alt" aria-hidden="true"></i>Password <font color='red'>  *</font></label>
       ...
       if(email!="" && pass!="")
       {
        ...
        ({
            ...
            success:function(response) {
              if((response=="Staff") || (response=="Admin") || (response=="Superior") || (response=="HR"))
              {
                console.log("/DK/" + response + "/Records.php")
                setTimeout(function(){
                  window.location.href= "/DK/" + response + "/Records.php";
                }, 1000)
              }
              else
              {
